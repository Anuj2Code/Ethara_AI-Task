...
// GET /api/tasks — filtered, sorted, paginated
const getTasks = async (req, res) => {
  try {
    ...
    // Access control: members see only tasks in their projects
...
const updateTask = async (req, res) => {
  try {
    ...
    const fields = ['title', 'description', 'assignedTo', 'status', 'priority', 'dueDate'];
    fields.forEach((f) => {
